    ...
    <form class="needs-validation" action="{{ url('/bkash/create-payment') }}" method="POST">
      ...
      <div class="mb-4 required">
        ...
        <div class="input-group has-validation">
          ...
          <input type="number" class="form-control @error('phone') is-invalid @enderror" id="phone-field" name="phone"
      ...
      <div class="mb-4 required">
        ...
        <div id="ticket-input">
          ...
          <input type="number" @error('tickets') style="border: 2px solid #DC3534" @enderror id="tickets-field"
            name="tickets" value="{{old('tickets', '2')}}" min="1" required>
